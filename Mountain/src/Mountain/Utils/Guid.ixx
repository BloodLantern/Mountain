export module Mountain:Utils_Guid;
...
export namespace Mountain
{
    ...
    struct MOUNTAIN_API Guid final
    {
        ...
        /// @brief Creates a new @c Guid
        /// @return New guid
        static Guid New();

        /// @brief Parses a @c Guid from a string
        /// @param str String
        /// @returns Guid
        ...
        /// @brief Compares 2 @c Guid
        /// @param other Other guid
        /// @return Whether the @c Guid are equal
        [[nodiscard]]
        bool_t operator==(const Guid& other) const;

        /// @brief Compares 2 @c Guid
        /// @param other Other guid
        /// @return Whether the @c Guid are different
        [[nodiscard]]
        bool_t operator!=(const Guid& other) const;

        /// @brief Converts a @c Guid to a string representation
