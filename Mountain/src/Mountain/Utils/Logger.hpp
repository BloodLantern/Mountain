...
namespace Mountain
{
    ...
    public:
        ...
        /// @details Defaults to LogLevel::Debug in a debug build, or LogLevel::Info otherwise.
        ...
        /// @details Defaults to LogLevel::Info in a debug build, or LogLevel::Warning otherwise.
        ...
        /// @note This function shouldn't be used directly. To print a temporary debug log message, instead use @c DEBUG_LOG().
        /// @see Log
        /// @see LogLevel::Debug
        template <Requirements::Formattable... Args>
        ...
        /// @details If a file is already open for logging e.g. if Logger::HasFileOpen returns @c true, this overwrites it with the new file.
        ...
        /// @details This function is called automatically when the Game is constructed.
        /// After a call to this function, you can use the Log functions.
        /// @details This function doesn't do anything if the logger has already been started.
        MOUNTAIN_API static void Start();

        /// @brief Synchronizes the threads and stops the logger.
        /// @details This function is called automatically when the Game is destroyed.
