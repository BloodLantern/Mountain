...
f32 Hitbox::Left() const { return offset.x; }

f32 Hitbox::Right() const { return offset.x + size.x; }

f32 Hitbox::Top() const { return offset.y; }

f32 Hitbox::Bottom() const { return offset.y + size.y; }

f32 Hitbox::AbsoluteLeft() const { return GetActualPosition().x; }

f32 Hitbox::AbsoluteRight() const { return GetActualPosition().x + size.x; }

f32 Hitbox::AbsoluteTop() const { return GetActualPosition().y; }

f32 Hitbox::AbsoluteBottom() const { return GetActualPosition().y + size.y; }

f32 Hitbox::Width() const { return size.x; }

f32 Hitbox::Height() const { return size.y; }
