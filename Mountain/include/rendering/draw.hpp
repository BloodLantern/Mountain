...
public:
    ...
    MOUNTAIN_API static void Line(Vector2 p1, Vector2 p2, const Color& color = Color::White());
    /// @brief Draw a line
    /// @param p1 The first point of the line
    /// @param p2 The second point of the line
    /// @param color1 The color of the first point
    /// @param color2 The color of the second point
    MOUNTAIN_API static void Line(Vector2 p1, Vector2 p2, const Color& color1, const Color& color2);
    ...
    MOUNTAIN_API static void Triangle(Vector2 p1, Vector2 p2, Vector2 p3, const Color& color = Color::White());
    /// @brief Draw a hollow triangle
    /// @param p1 The first point
    /// @param p2 The second point
    /// @param p3 The third point
    ...
    MOUNTAIN_API static void Triangle(Vector2 p1, Vector2 p2, Vector2 p3, const Color& color1, const Color& color2, const Color& color3);
    /// @brief Draw a filled triangle
    /// @param p1 The first point
    /// @param p2 The second point
    /// @param p3 The third point
    /// @param color The color of the triangle
    MOUNTAIN_API static void TriangleFilled(Vector2 p1, Vector2 p2, Vector2 p3, const Color& color = Color::White());
    /// @brief Draw a filled triangle
    /// @param p1 The first point
    /// @param p2 The second point
    /// @param p3 The third point
    ...
    /// @param color2 The color of the second point
    /// @param color3 The color of the third point
    MOUNTAIN_API static void TriangleFilled(Vector2 p1, Vector2 p2, Vector2 p3, const Color& color1, const Color& color2, const Color& color3);
    ...
    /// @param color3 The color of the third point
    /// @param color4 The color of the fourth point
    MOUNTAIN_API static void Rectangle(const Mountain::Rectangle& rectangle, const Color& color1, const Color& color2, const Color& color3, const Color& color4);
    ...
    /// @param color3 The color of the third point
    /// @param color4 The color of the fourth point
    MOUNTAIN_API static void RectangleFilled(Vector2 position, Vector2 size, const Color& color1, const Color& color2, const Color& color3, const Color& color4);
    /// @brief Draw a filled rectangle
    /// @param rectangle The rectangle position and size
    /// @param color1 The color of the first point
    /// @param color2 The color of the second point
    /// @param color3 The color of the third point
    /// @param color4 The color of the fourth point
    MOUNTAIN_API static void RectangleFilled(const Mountain::Rectangle& rectangle, const Color& color1, const Color& color2, const Color& color3, const Color& color4);
    ...
    MOUNTAIN_API static void Texture(const Texture& texture, Vector2 position, Vector2 scale = Vector2::One(), float_t rotation = 0.f, const Color& color = Color::White());
    ...
    MOUNTAIN_API static void RenderTarget(const RenderTarget& renderTarget, Vector2 position = Vector2::Zero(), Vector2 scale = Vector2::One(), float_t rotation = 0, const Color& color = Color::White());
...
private:
    ...
    static void TriangleInternal(Vector2 p1, Vector2 p2, Vector2 p3, const Color& color, bool_t filled);
    static void TriangleInternal(Vector2 p1, Vector2 p2, Vector2 p3, const Color& color1, const Color& color2, const Color& color3, bool_t filled);
    
    static void RectangleInternal(const Mountain::Rectangle& rectangle, const Color& color, bool_t filled);
    static void RectangleInternal(const Mountain::Rectangle& rectangle, const Color& color1, const Color& color2, const Color& color3, const Color& color4, bool_t filled);

    static void CircleInternal(Vector2 position, float_t radius, const Color& color, uint32_t segments, bool_t dotted);
    
    static void TextureInternal(uint32_t textureId, Vector2i textureSize, const Shader& shader, Vector2 position, Vector2 scale, float_t rotation, const Color& color);
