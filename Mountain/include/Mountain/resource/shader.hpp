...
public:
	...
	/// @param value Value
	MOUNTAIN_API void SetUniform(const std::string_view& keyName, int32_t value) const;

	/// @brief Sets a bool (signed, 32 bits) variable in a shader
	/// @param keyName Variable name
	/// @param value Value
	MOUNTAIN_API void SetUniform(const std::string_view& keyName, bool_t value) const;

	/// @brief Sets a float (32 bits) variable in a shader
	/// @param keyName Variable name
	/// @param value Value
	MOUNTAIN_API void SetUniform(const std::string_view& keyName, float_t value) const;

	/// @brief Sets a Vector2 (2 floats, 64 bits) variable in a shader
	/// @param keyName Variable name
	/// @param value Value
	MOUNTAIN_API void SetUniform(const std::string_view& keyName, const Vector2& value) const;
	
	/// @brief Sets a Vector3 (3 floats, 96 bits) variable in a shader
	/// @param keyName Variable name
	/// @param value Value
	MOUNTAIN_API void SetUniform(const std::string_view& keyName, const Vector3& value) const;
	
	/// @brief Sets a Vector4 (4 floats, 128 bits) variable in a shader
	/// @param keyName Variable name
	/// @param value Value
	MOUNTAIN_API void SetUniform(const std::string_view& keyName, const Vector4& value) const;
	...
	/// @param keyName Variable name
	/// @param value Value
	MOUNTAIN_API void SetUniform(const std::string_view& keyName, const Matrix3& value) const;

	/// @brief Sets a Matrix (16 floats, 512 bits) variable in a shader
	/// @param keyName Variable name
	/// @param value Value
	MOUNTAIN_API void SetUniform(const std::string_view& keyName, const Matrix& value) const;
