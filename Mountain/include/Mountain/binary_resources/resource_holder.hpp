...
#include "embedded_resources/resource_13041558764341956120.hpp"
...
private:
	std::array<Resource, 21> resources {
		...
		Resource(resource_13041558764341956120,	resource_13041558764341956120_path),
