...
export namespace Calc
{
    ...
    [[nodiscard]]
	MATH_API constexpr float_t Sign(float_t number) noexcept;
	...
	[[nodiscard]]
	MATH_API constexpr float_t Abs(float_t number) noexcept;
	...
	[[nodiscard]]
	MATH_API constexpr Vector2 Abs(Vector2 vector) noexcept;
	...
	[[nodiscard]]
	MATH_API constexpr Vector3 Abs(const Vector3& vector) noexcept;
	...
	[[nodiscard]]
	MATH_API constexpr Vector4 Abs(const Vector4& vector) noexcept;
	...
	[[nodiscard]]
	MATH_API constexpr float_t Round(float_t number) noexcept;
	...
	[[nodiscard]]
	MATH_API constexpr Vector2 Round(Vector2 vector) noexcept;
	...
	[[nodiscard]]
	MATH_API constexpr Vector3 Round(const Vector3& vector) noexcept;
	...
	[[nodiscard]]
	MATH_API constexpr Vector4 Round(const Vector4& vector) noexcept;
    ...
    [[nodiscard]]
	MATH_API constexpr float_t Floor(float_t number) noexcept;
	...
	[[nodiscard]]
	MATH_API constexpr Vector2 Floor(Vector2 vector) noexcept;
	...
	[[nodiscard]]
	MATH_API constexpr Vector3 Floor(const Vector3& vector) noexcept;
	...
	[[nodiscard]]
	MATH_API constexpr Vector4 Floor(const Vector4& vector) noexcept;
    ...
    [[nodiscard]]
	MATH_API constexpr float_t Ceil(float_t number) noexcept;
	...
	[[nodiscard]]
	MATH_API constexpr Vector2 Ceil(Vector2 vector) noexcept;
	...
	[[nodiscard]]
	MATH_API constexpr Vector3 Ceil(const Vector3& vector) noexcept;
	...
	[[nodiscard]]
	MATH_API constexpr Vector4 Ceil(const Vector4& vector) noexcept;
	...
	[[nodiscard]]
	MATH_API constexpr float_t Clamp(float_t number, float_t min, float_t max) noexcept;
	...
	[[nodiscard]]
	MATH_API constexpr Vector2 Clamp(Vector2 vector, Vector2 min, Vector2 max) noexcept;
	...
	/// @returns The clamped vector.
	[[nodiscard]]
	MATH_API constexpr Vector3 Clamp(const Vector3& vector, const Vector3& min, const Vector3& max) noexcept;
	...
	/// @returns The clamped vector.
	[[nodiscard]]
	MATH_API constexpr Vector4 Clamp(const Vector4& vector, const Vector4& min, const Vector4& max) noexcept;
	...
	[[nodiscard]]
	MATH_API constexpr float_t Modulo(float_t a, float_t b) noexcept;
	...
	MATH_API constexpr void Approach(float_t& value, float_t target, float_t step) noexcept;
	...
	[[nodiscard]]
	MATH_API constexpr float_t YoYo(float_t value) noexcept;
	...
	[[nodiscard]]
	MATH_API constexpr bool_t OnInterval(float_t value, float_t lastValue, float_t interval);

	/// @brief Clamps the given @p value between @p min and @p max and remaps the result between @p newMin and @p newMax
	[[nodiscard]]
	MATH_API constexpr float_t ClampedMap(
		float_t value,
		float_t min,
		float_t max,
		float_t newMin = 0.f,
    ...
    [[nodiscard]]
    MATH_API constexpr bool_t IsZero(float_t value) noexcept;
    ...
    /// @returns Whether the value is considered to be zero.
    [[nodiscard]]
    MATH_API constexpr bool_t IsZero(float_t value, float_t zero) noexcept;
    ...
    /// @returns Whether the value is considered to be zero.
    [[nodiscard]]
    MATH_API constexpr float_t MakeZero(float_t value) noexcept;
    ...
    /// @returns Whether the value is considered to be zero.
    [[nodiscard]]
	MATH_API constexpr float_t MakeZero(float_t value, float_t zero) noexcept;
	...
	[[nodiscard]]
	MATH_API constexpr bool_t Equals(float_t a, float_t b) noexcept;
	...
	/// @returns Whether the values are considered equal.
	[[nodiscard]]
	MATH_API constexpr bool_t Equals(Vector2 a, Vector2 b) noexcept;
	...
	/// @returns Whether the values are considered equal.
	[[nodiscard]]
	MATH_API constexpr bool_t Equals(const Vector3& a, const Vector3& b) noexcept;
	...
	/// @returns Whether the values are considered equal.
	[[nodiscard]]
	MATH_API constexpr bool_t Equals(const Vector4& a, const Vector4& b) noexcept;
	...
	/// @returns Whether the values are considered equal.
	[[nodiscard]]
	MATH_API bool_t Equals(const Matrix2& a, const Matrix2& b) noexcept;
	...
	/// @returns Whether the values are considered equal.
	[[nodiscard]]
	MATH_API bool_t Equals(const Matrix3& a, const Matrix3& b) noexcept;
	...
	/// @returns Whether the values are considered equal.
	[[nodiscard]]
	MATH_API bool_t Equals(const Matrix& a, const Matrix& b) noexcept;
	...
	/// @returns Whether the values are considered equal.
	[[nodiscard]]
	MATH_API bool_t Equals(const Quaternion& a, const Quaternion& b) noexcept;
...
namespace Calc
{
	...
	constexpr Vector2 Abs(const Vector2 vector) noexcept { return { Abs(vector.x), Abs(vector.y) }; }

	constexpr Vector3 Abs(const Vector3& vector) noexcept { return { Abs(vector.x), Abs(vector.y), Abs(vector.z) }; }

	constexpr Vector4 Abs(const Vector4& vector) noexcept { return { Abs(vector.x), Abs(vector.y), Abs(vector.z), Abs(vector.w) }; }

	constexpr float_t Round(const float_t number) noexcept
	{
	...
	constexpr Vector2 Round(const Vector2 vector) noexcept { return { Round(vector.x), Round(vector.y) }; }

	constexpr Vector3 Round(const Vector3& vector) noexcept { return { Round(vector.x), Round(vector.y), Round(vector.z) }; }

	constexpr Vector4 Round(const Vector4& vector) noexcept { return { Round(vector.x), Round(vector.y), Round(vector.z), Round(vector.w) }; }

	constexpr float_t Floor(const float_t number) noexcept { return Round(number - 0.5f); }

	constexpr Vector2 Floor(const Vector2 vector) noexcept { return { Floor(vector.x), Floor(vector.y) }; }

	constexpr Vector3 Floor(const Vector3& vector) noexcept { return { Floor(vector.x), Floor(vector.y), Floor(vector.z) }; }

	constexpr Vector4 Floor(const Vector4& vector) noexcept { return { Floor(vector.x), Floor(vector.y), Floor(vector.z), Floor(vector.w) }; }

	constexpr float_t Ceil(const float_t number) noexcept { return Round(number + 0.5f); }

	constexpr Vector2 Ceil(const Vector2 vector) noexcept { return { Ceil(vector.x), Ceil(vector.y) }; }

	constexpr Vector3 Ceil(const Vector3& vector) noexcept { return { Ceil(vector.x), Ceil(vector.y), Ceil(vector.z) }; }

	constexpr Vector4 Ceil(const Vector4& vector) noexcept { return { Ceil(vector.x), Ceil(vector.y), Ceil(vector.z), Ceil(vector.w) }; }

	constexpr float_t Clamp(const float_t number, const float_t min, const float_t max) noexcept
	{
		if (number < min)
			return min;
		if (number > max)
	...
	constexpr Vector2 Clamp(const Vector2 vector, const Vector2 min, const Vector2 max) noexcept
	{
	...
	constexpr float_t Modulo(const float_t a, const float_t b) noexcept { return a - static_cast<float_t>(static_cast<int64_t>(a / b)) * b; }

	// Undef windows macro to be able to use std::min without conflicts
	#undef min

	constexpr void Approach(float_t &value, const float_t target, const float_t step) noexcept
	{
	...
	constexpr float_t YoYo(const float_t value) noexcept { return value <= 0.5f ? value * 2.f : 1.f - (value - 0.5f) * 2.f; }

	constexpr bool_t OnInterval(const float_t value, const float_t lastValue, const float_t interval)
	{
		return IsZero(interval) || static_cast<int32_t>(lastValue / interval) != static_cast<int32_t>(value / interval);
	}

	constexpr float_t ClampedMap(const float_t value, const float_t min, const float_t max, const float_t newMin, const float_t newMax)
	{
		return Clamp((value - min) / (max - min), 0.f, 1.f) * (newMax - newMin) + newMin;
	}

	constexpr bool_t IsZero(const float_t value) noexcept { return IsZero(value, Zero); }

	constexpr bool_t IsZero(const float_t value, const float_t zero) noexcept { return Abs(value) <= zero; }

	constexpr float_t MakeZero(const float_t value) noexcept { return MakeZero(value, Zero); }

	constexpr float_t MakeZero(const float_t value, const float_t zero) noexcept { return IsZero(value, zero) ? 0.f : value; }

	constexpr bool_t Equals(const float_t a, const float_t b) noexcept { return IsZero(a - b); }

	constexpr bool_t Equals(const Vector2 a, const Vector2 b) noexcept { return Equals(a.x, b.x) && Equals(a.y, b.y); }

	constexpr bool_t Equals(const Vector3& a, const Vector3& b) noexcept { return Equals(a.x, b.x) && Equals(a.y, b.y) && Equals(a.z, b.z); }

	constexpr bool_t Equals(const Vector4& a, const Vector4& b) noexcept { return Equals(a.x, b.x) && Equals(a.y, b.y) && Equals(a.z, b.z) && Equals(a.w, b.w); }

	constexpr float_t Lerp(const float_t value, const float_t target, const float_t time) { return value + (target - value) * time; }

	constexpr float_t Lerp(const float_t value, const float_t target, const float_t time, const Easing::Easer easer)
	{
		return value + (target - value) * easer(time);
	}

	constexpr Vector2 Lerp(const Vector2 value, const Vector2 target, const float_t time) { return value + (target - value) * time; }

	constexpr Vector2 Lerp(const Vector2 value, const Vector2 target, const float_t time, const Easing::Easer easer)
	{
		return value + (target - value) * easer(time);
	}

	constexpr Vector3 Lerp(const Vector3& value, const Vector3& target, const float_t time) { return value + (target - value) * time; }

	constexpr Vector3 Lerp(const Vector3& value, const Vector3& target, const float_t time, const Easing::Easer easer)
	{
		return value + (target - value) * easer(time);
	}

	constexpr Vector4 Lerp(const Vector4& value, const Vector4& target, const float_t time) { return value + (target - value) * time; }

	constexpr Vector4 Lerp(const Vector4& value, const Vector4& target, const float_t time, const Easing::Easer easer)
	{
		return value + (target - value) * easer(time);
	}
}
