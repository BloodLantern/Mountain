...
extern u8 gClipdataCollisionTypes[1024 * 2];
extern u8 gClipdataCollisionTypes_Tilemap[512];

extern u16 gClipdataBehaviorTypes[1024 * 2];
...
extern u16 gDecompClipdataMap[0x1800];
extern u16 gDecompBg0Map[0x1800];
extern u16 gDecompBg1Map[0x1800];
extern u16 gDecompBg2Map[0x1800];
