...
#define REG_BG0CNT (gRegBuffer + 0x008)
#define REG_BG1CNT (gRegBuffer + 0x00A)
#define REG_BG2CNT (gRegBuffer + 0x00C)
#define REG_BG3CNT (gRegBuffer + 0x00E)

#define REG_BG0HOFS (gRegBuffer + 0x010)
#define REG_BG0VOFS (gRegBuffer + 0x012)

#define REG_BG1HOFS (gRegBuffer + 0x014)
#define REG_BG1VOFS (gRegBuffer + 0x016)

#define REG_BG2HOFS (gRegBuffer + 0x018)
#define REG_BG2VOFS (gRegBuffer + 0x01A)

#define REG_BG3HOFS (gRegBuffer + 0x01C)
#define REG_BG3VOFS (gRegBuffer + 0x01E)

#define REG_BG2PA (gRegBuffer + 0x020)
#define REG_BG2PB (gRegBuffer + 0x022)
#define REG_BG2PC (gRegBuffer + 0x024)
#define REG_BG2PD (gRegBuffer + 0x026)

#define REG_BG2X (gRegBuffer + 0x028)
#define REG_BG2Y (gRegBuffer + 0x02C)

#define REG_DISPSTAT (gRegBuffer + 0x004)
#define REG_WIN0H (gRegBuffer + 0x040)
#define REG_WIN1H (gRegBuffer + 0x042)
#define REG_WIN0V (gRegBuffer + 0x044)
#define REG_WIN1V (gRegBuffer + 0x046)
#define REG_WININ (gRegBuffer + 0x048)
#define REG_WINOUT (gRegBuffer + 0x04A)
#define REG_MOSAIC (gRegBuffer + 0x04C)
#define REG_BLDCNT (gRegBuffer + 0x050)
#define REG_BLDALPHA (gRegBuffer + 0x052)
#define REG_BLDY (gRegBuffer + 0x054)
...
#define BGCNT_TO_VRAM_CHAR_BASE(val) (gVramBuffer + (val) * BGCNT_VRAM_CHAR_SIZE)
#define BGCNT_TO_VRAM_TILE_BASE(val) (gVramBuffer + (val) * BGCNT_VRAM_TILE_SIZE)
