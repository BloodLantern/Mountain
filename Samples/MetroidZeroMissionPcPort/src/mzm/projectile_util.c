...
void ProjectileLoadGraphics(void)
{
    ...
    if (gEquipment.suitType == SUIT_SUITLESS)
    {
        DMA_SET(3, sPistolGfx_Top, gVramBuffer + 0x11000, DMA_ENABLE << 16 | 0x80);
        DMA_SET(3, sPistolGfx_Bottom, gVramBuffer + 0x11400, DMA_ENABLE << 16 | 0x100);
        DMA_SET(3, sPistolGfx_Charged_Top, gVramBuffer + 0x11800, DMA_ENABLE << 16 | 0x100);
        DMA_SET(3, sPistolGfx_Charged_Bottom, gVramBuffer + 0x11C00, DMA_ENABLE << 16 | 0x100);
    ...
    else
    {
        ...
        {
            DMA_SET(3, sPlasmaBeamGfx_Top, gVramBuffer + 0x11000, DMA_ENABLE << 16 | 0x100);
            DMA_SET(3, sPlasmaBeamGfx_Bottom, gVramBuffer + 0x11400, DMA_ENABLE << 16 | 0x100);
            DMA_SET(3, sPlasmaBeamGfx_Charged_Top, gVramBuffer + 0x11800, DMA_ENABLE << 16 | 0x100);
            DMA_SET(3, sPlasmaBeamGfx_Charged_Bottom, gVramBuffer + 0x11C00, DMA_ENABLE << 16 | 0x100);
        ...
        {
            DMA_SET(3, sWaveBeamGfx_Top, gVramBuffer + 0x11000, DMA_ENABLE << 16 | 0x100);
            DMA_SET(3, sWaveBeamGfx_Bottom, gVramBuffer + 0x11400, DMA_ENABLE << 16 | 0x100);
            DMA_SET(3, sWaveBeamGfx_Charged_Top, gVramBuffer + 0x11800, DMA_ENABLE << 16 | 0x100);
            DMA_SET(3, sWaveBeamGfx_Charged_Bottom, gVramBuffer + 0x11C00, DMA_ENABLE << 16 | 0x100);
        ...
        {
            DMA_SET(3, sIceBeamGfx_Top, gVramBuffer + 0x11000, DMA_ENABLE << 16 | 0x100);
            DMA_SET(3, sIceBeamGfx_Bottom, gVramBuffer + 0x11400, DMA_ENABLE << 16 | 0x100);
            DMA_SET(3, sIceBeamGfx_Charged_Top, gVramBuffer + 0x11800, DMA_ENABLE << 16 | 0x100);
            DMA_SET(3, sIceBeamGfx_Charged_Bottom, gVramBuffer + 0x11C00, DMA_ENABLE << 16 | 0x100);

            palOffset = 0x20;
        }
        else if (bba & BBF_LONG_BEAM)
        {
            DMA_SET(3, sLongBeamGfx_Top, gVramBuffer + 0x11000, DMA_ENABLE << 16 | 0x100);
            DMA_SET(3, sLongBeamGfx_Bottom, gVramBuffer + 0x11400, DMA_ENABLE << 16 | 0x100);
            DMA_SET(3, sLongBeamGfx_Charged_Top, gVramBuffer + 0x11800, DMA_ENABLE << 16 | 0x100);
            DMA_SET(3, sLongBeamGfx_Charged_Bottom, gVramBuffer + 0x11C00, DMA_ENABLE << 16 | 0x100);

            palOffset = 0x10;
        }
        else
        {
            DMA_SET(3, sNormalBeamGfx_Top, gVramBuffer + 0x11000, DMA_ENABLE << 16 | 0x100);
            DMA_SET(3, sNormalBeamGfx_Bottom, gVramBuffer + 0x11400, DMA_ENABLE << 16 | 0x100);
            DMA_SET(3, sNormalBeamGfx_Charged_Top, gVramBuffer + 0x11800, DMA_ENABLE << 16 | 0x100);
            DMA_SET(3, sNormalBeamGfx_Charged_Bottom, gVramBuffer + 0x11C00, DMA_ENABLE << 16 | 0x100);

            palOffset = 0x0;
        }
    }
    
    DMA_SET(3, (sBeamPAL + palOffset), gPalramBuffer + 0x240, DMA_ENABLE << 16 | 6);
}
...
u8 ProjectileIceBeamDealDamage(struct SpriteData* pSprite, u16 damage)
{
    ...
    SPRITE_CLEAR_AND_SET_ISFT(*pSprite, 0x11);
