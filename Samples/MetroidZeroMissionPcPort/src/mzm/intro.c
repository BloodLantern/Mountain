...
{
    DMA_SET(3, gOamData, gOamBuffer, C_32_2_16(DMA_ENABLE | DMA_32BIT, OAM_SIZE / sizeof(u32)));
...
void IntroFuzzVBlank(void)
{
    ...
    DMA_SET(3, INTRO_DATA.fuzzPalette, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]), C_32_2_16(DMA_ENABLE, ARRAY_SIZE(INTRO_DATA.fuzzPalette)));
}
...
void IntroInit(void)
{
    ...
    LZ77UncompVRAM(sIntroSpaceBackgroundTileTable, gVramBuffer + 0x8000);
    LZ77UncompVRAM(sIntro_47920c, gVramBuffer + 0x9000);

    DMA_SET(3, sIntroTextAndShipPAL, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]), C_32_2_16(DMA_ENABLE, ARRAY_SIZE(sIntroTextAndShipPAL)));
    DMA_SET(3, sIntroTextAndShipPAL, gPalramBuffer, C_32_2_16(DMA_ENABLE, ARRAY_SIZE(sIntroTextAndShipPAL)));
    DMA_SET(3, sIntroPAL_45f9d4, gPalramBuffer + 0x1E0, C_32_2_16(DMA_ENABLE, ARRAY_SIZE(sIntroPAL_45f9d4)));
...
u8 IntroSamusInHerShip(void)
{
    ...
    {
        case 0:
            LZ77UncompVRAM(sIntroSamusInHerShipGfx, gVramBuffer);
            break;

        case 1:
            LZ77UncompVRAM(sIntroSamusInHerShipTileTable, gVramBuffer + 0x8000);
            break;

        case 2:
            DMA_SET(3, sIntroSamusInHerShipPAL, gPalramBuffer, C_32_2_16(DMA_ENABLE, ARRAY_SIZE(sIntroSamusInHerShipPAL)));
            break;
...
u8 IntroViewOfZebes(void)
{
    ...
    {
        case 0:
            LZ77UncompVRAM(sIntroSamusShipViewOfZebesGfx, gVramBuffer + 0x10800);
            break;

        case 1:
            LZ77UncompVRAM(sIntroViewOfZebesGfx, gVramBuffer);
            break;

        case 2:
            LZ77UncompVRAM(sIntroViewOfZebesTileTable, gVramBuffer + 0x8000);
            DMA_SET(3, sIntroViewOfZebesPAL, gPalramBuffer, C_32_2_16(DMA_ENABLE, ARRAY_SIZE(sIntroViewOfZebesPAL)));
            DMA_SET(3, sIntroViewOfZebesPAL, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]), C_32_2_16(DMA_ENABLE, ARRAY_SIZE(sIntroViewOfZebesPAL)));
...
u8 IntroMotherBrain(void)
{
    ...
    switch (INTRO_DATA.timer)
    {
        ...
        case 1:
            LZ77UncompVRAM(sIntroMotherBrainGfx, gVramBuffer);
            break;

        case 2:
            LZ77UncompVRAM(sIntroMotherBrainTileTable, gVramBuffer + 0x8000);
            gBg0XPosition = 0;
            gBg0YPosition = 0x60;
            break;

        case 3:
            DMA_SET(3, sIntroMotherBrainPAL, gPalramBuffer, C_32_2_16(DMA_ENABLE, ARRAY_SIZE(sIntroMotherBrainPAL)));
            INTRO_DATA.dispcnt = DCNT_BG0;
            SoundPlay(0x22A);
            SoundPlay(0x39);
            break;
