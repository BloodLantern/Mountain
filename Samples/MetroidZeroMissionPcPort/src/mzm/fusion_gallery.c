...
void FusionGalleryInit(void)
{
    ...
    LZ77UncompVRAM(sFusionGalleryData[image].pTopGfx, gVramBuffer);
    LZ77UncompVRAM(sFusionGalleryData[image].pBottomGfx, gVramBuffer + 0x8000);
    LZ77UncompVRAM(sFusionGalleryData[image].pTopTileTable, gVramBuffer + 0xE000);
    LZ77UncompVRAM(sFusionGalleryData[image].pBottomTileTable, gVramBuffer + 0xF800);

    BitFill(3, 0x4FF04FF, gVramBuffer + 0xE800, 0x800, 32);
    DMA_SET(3, sFusionGalleryData[image].pPalette, gPalramBuffer, DMA_ENABLE << 16 | PALRAM_SIZE / 4);
