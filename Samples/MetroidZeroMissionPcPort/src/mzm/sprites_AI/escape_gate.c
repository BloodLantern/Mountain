...
void EscapeGate(void)
{
    ...
    switch (gCurrentSprite.pose)
    {
        ...
        case ESCAPE_GATE_POSE_LOAD_GRAPHICS:
            if (spriteId == PSPRITE_ESCAPE_GATE1)
            {
                ...
                DMA_SET(3, sEscapeGateAndTimerGfx, gVramBuffer + 0x17800, (DMA_ENABLE << 16) | 0x400);
                DMA_SET(3, sEscapeGateAndTimerPAL, gPalramBuffer + 0x3E0, (DMA_ENABLE << 16) | 0x10);
    ...
    if (spriteId == PSPRITE_ESCAPE_GATE1)
    {
        ...
        if (timer == 0)
        {
            ...
            DMA_SET(3, &sEscapeGateFlashingPAL[offset * 16], gPalramBuffer + 0x3E0, (DMA_ENABLE << 16) | 16);
        }
    }
}
