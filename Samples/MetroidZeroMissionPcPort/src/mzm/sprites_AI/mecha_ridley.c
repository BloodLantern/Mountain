...
void MechaRidleyPartGreenGlow(void)
{
    ...
    else
    {
        ...
        DMA_SET(3, &sMechaRidleyGreenGlowPAL[palRow * 16],
            gPalramBuffer + 0x31A + gCurrentSprite.absolutePaletteRow * 32,
            (DMA_ENABLE << 16) | 3);
    }
}
...
void MechaRidleyLoadFireballsGfx(void)
{
    ...
    if (gBossWork.work6 == 0 && gBossWork.work8 != 0)
    {
        ...
        // Load graphics
        DMA_SET(3, &sMechaRidleyWeaponsGfx[3 * 32 +stage * 32], gVramBuffer + 0x14280, (DMA_ENABLE << 16) | 64);
        DMA_SET(3, &sMechaRidleyWeaponsGfx[11 * 32 + stage * 32], gVramBuffer + 0x14680, (DMA_ENABLE << 16) | 64);
        DMA_SET(3, &sMechaRidleyWeaponsGfx[19 * 32 + stage * 32], gVramBuffer + 0x14A80, (DMA_ENABLE << 16) | 64);
        DMA_SET(3, &sMechaRidleyWeaponsGfx[27 * 32 + stage * 32], gVramBuffer + 0x14E80, (DMA_ENABLE << 16) | 64);
    }
}
...
void MechaRidleyLoadMissilesGfx(void)
{
    ...
    if (gBossWork.work8 == 0 && gBossWork.work6 != 0)
    {
        ...
        // Load graphics
        DMA_SET(3, &sMechaRidleyWeaponsGfx[stage * 32], gVramBuffer + 0x14280, (DMA_ENABLE << 16) | 64);
        DMA_SET(3, &sMechaRidleyWeaponsGfx[8 * 32 + stage * 32], gVramBuffer + 0x14680, (DMA_ENABLE << 16) | 64);
        DMA_SET(3, &sMechaRidleyWeaponsGfx[16 * 32 + stage * 32], gVramBuffer + 0x14A80, (DMA_ENABLE << 16) | 64);
        DMA_SET(3, &sMechaRidleyWeaponsGfx[24 * 32 + stage * 32], gVramBuffer + 0x14E80, (DMA_ENABLE << 16) | 64);
    }
}
...
void MechaRidleyStartWalking(void)
{
    ...
    DMA_SET(3, sMechaRidleyFadingPAL, gPalramBuffer + 0x300, (DMA_ENABLE << 16) | 13);
    ...
    if (--gCurrentSprite.workVariable == 0)
    {
        ...
        else
        {
            ...
            DMA_SET(3, &sMechaRidleyFadingPAL[palRow * 16],
                gPalramBuffer + 0x300, (DMA_ENABLE << 16) | 13);
...
void MechaRidleyGlowFading(void)
{
    ...
    {
        case 0:
            DMA_SET(3, sMechaRidleyDestroyedGfx, gVramBuffer + 0x15580, (DMA_ENABLE << 16) | 0x40);
            break;

        case 1:
            DMA_SET(3, &sMechaRidleyDestroyedGfx[0x30], gVramBuffer + 0x15980, (DMA_ENABLE << 16) | 0x60);
            break;

        case 2:
            DMA_SET(3, &sMechaRidleyDestroyedGfx[0x60], gVramBuffer + 0x15D80, (DMA_ENABLE << 16) | 0x60);
            break;

        case 3:
            DMA_SET(3, &sMechaRidleyDestroyedGfx[0x90], gVramBuffer + 0x16180, (DMA_ENABLE << 16) | 0x60);
            break;

        case 4:
            DMA_SET(3, &sMechaRidleyDestroyedGfx[0xC0], gVramBuffer + 0x16580, (DMA_ENABLE << 16) | 0x60);
            break;

        case 5:
            DMA_SET(3, &sMechaRidleyDestroyedGfx[0x100], gVramBuffer + 0x169C0, (DMA_ENABLE << 16) | 0x40);
            break;

        case 6:
            DMA_SET(3, &sMechaRidleyDestroyedGfx[0x130], gVramBuffer + 0x16DC0, (DMA_ENABLE << 16) | 0x40);
            break;

        case 8:
            DMA_SET(3, sMechaRidley_8323b42_PAL, gPalramBuffer + 0x39A, (DMA_ENABLE << 16) | 3);
            break;

        case 16:
            DMA_SET(3, sMechaRidley_8323b62_PAL, gPalramBuffer + 0x39A, (DMA_ENABLE << 16) | 3);
            break;
    }
...
void MechaRidleySpawnDrops(void)
{
    ...
    {
        case 1:
            DMA_SET(3, sMechaRidley_8323aaa_PAL, gPalramBuffer + 0x322, (DMA_ENABLE << 16) | 6);
            break;

        case 6:
            DMA_SET(3, &sMechaRidleyGreenGlowPAL[4], gPalramBuffer + 0x322, (DMA_ENABLE << 16) | 6);
            break;

        case 12:
            DMA_SET(3, &sMechaRidleyGreenGlowPAL[20], gPalramBuffer + 0x322, (DMA_ENABLE << 16) | 6);
            break;
...
void MechaRidleyFirstEyeGlow(void)
{
    if (--gCurrentSprite.workVariable2 == 0)
    {
        ...
        {
            gCurrentSprite.workVariable = 0;
            DMA_SET(3, &sMechaRidleyGreenGlowPAL[2 * 16 + 4], gPalramBuffer + 0x322, (DMA_ENABLE << 16) | 6);
        }
        else
        {
            gCurrentSprite.workVariable = 1;
            DMA_SET(3, &sMechaRidleyGreenGlowPAL[3 * 16 + 4], gPalramBuffer + 0x322, (DMA_ENABLE << 16) | 6);
        }
    }
...
void MechaRidleySecondEyeGlow(void)
{
    if (--gCurrentSprite.workVariable2 == 0)
    {
        ...
        {
            gCurrentSprite.workVariable = 1;
            DMA_SET(3, sMechaRidley_8323b4a_PAL, gPalramBuffer + 0x322, (DMA_ENABLE << 16) | 6);
        }
    }
