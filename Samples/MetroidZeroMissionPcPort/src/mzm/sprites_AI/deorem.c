...
void DeoremSpawnGoingDown(void)
{
    ...
    {        
        ...
        SpriteSpawnSecondary(SSPRITE_DEOREM_SEGMENT, 5, gfxSlot, ramSlot, yPosition, xPosition, 0);
        SpriteSpawnSecondary(SSPRITE_DEOREM_SEGMENT, 4, gfxSlot, ramSlot, yPosition, xPosition, 0);
        SpriteSpawnSecondary(SSPRITE_DEOREM_SEGMENT, 3, gfxSlot, ramSlot, yPosition, xPosition, 0);
        SpriteSpawnSecondary(SSPRITE_DEOREM_SEGMENT, 2, gfxSlot, ramSlot, yPosition, xPosition, 0);
        SpriteSpawnSecondary(SSPRITE_DEOREM_SEGMENT, 1, gfxSlot, ramSlot, yPosition, xPosition, 0);
        SpriteSpawnSecondary(SSPRITE_DEOREM_SEGMENT, 0, gfxSlot, ramSlot, yPosition, xPosition, 0);
...
void DeoremSegmentRightIdleAnim(void)
{
    ...
    ramSlot = gCurrentSprite.primarySpriteRamSlot;
    deoremTimer = gSpriteData[ramSlot].timer;
