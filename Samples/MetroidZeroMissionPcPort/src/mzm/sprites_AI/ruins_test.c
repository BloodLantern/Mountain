...
void RuinsTestSamusReflectionStart(void)
{
    ...
    switch (gCurrentSprite.pose)
    {
        case SPRITE_POSE_UNINITIALIZED:
            ...
            DMA_SET(3, sRuinsTestPal_SamusReflection, (gPalramBuffer + 0x3E0), C_32_2_16(DMA_ENABLE, 16));
        ...
        case RUINS_TEST_SAMUS_REFLECTION_START_POSE_UPDATE_Gfx_PAL:
            if (gCurrentSprite.timer < 16)
            {
                ...
                if (timer > 14)
                {
                    DMA_SET(3, &sRuinsTestPal[16 * 7], (gPalramBuffer + 0x3E0), C_32_2_16(DMA_ENABLE, 16));
                }
                else
                {
                    DMA_SET(3, &sRuinsTestPal_SamusReflection[timer * 16], (gPalramBuffer + 0x3E0), C_32_2_16(DMA_ENABLE, 16));
                }
            ...
            if (gSamusData.pose != SPOSE_FACING_THE_BACKGROUND_SUITLESS)
            {
                ...
                {
                    DMA_SET(3, sRuinsTestGfx_SamusReflectionTurningRightTop, (gVramBuffer + 0x14280), (DMA_ENABLE << 16) | 192);
                    DMA_SET(3, sRuinsTestGfx_SamusReflectionTurningRightBottom, (gVramBuffer + 0x14680), (DMA_ENABLE << 16) | 128);
                }
                else
                {
                    DMA_SET(3, sRuinsTestGfx_SamusReflectionTurningLeftTop, (gVramBuffer + 0x14280), (DMA_ENABLE << 16) | 192);
                    DMA_SET(3, sRuinsTestGfx_SamusReflectionTurningLeftBottom, (gVramBuffer + 0x14680), (DMA_ENABLE << 16) | 128);
                }
            }
            break;
...
void RuinsTestSamusReflectionEnd(void)
{
    ...
    switch (gCurrentSprite.pose)
    {
        case SPRITE_POSE_UNINITIALIZED:
            ...
            DMA_SET(3, sRuinsTestGfx_SamusReflectionSuitlessTop, (gVramBuffer + 0x14280), C_32_2_16(DMA_ENABLE, 192));
            DMA_SET(3, sRuinsTestGfx_SamusReflectionSuitlessBottom, (gVramBuffer + 0x14680), C_32_2_16(DMA_ENABLE, 128));
            DMA_SET(3, sRuinsTestPal_SamusReflection, (gPalramBuffer + 0x3E0), C_32_2_16(DMA_ENABLE, 16));
        ...
        case RUINS_TEST_SAMUS_REFLECTION_END_POSE_SUITLESS:
            ...
            if (--gCurrentSprite.workVariable2 == 0)
            {
                ...
                DMA_SET(3, (sRuinsTestPal_SamusReflection + offset * 16), (gPalramBuffer + 0x3E0), C_32_2_16(DMA_ENABLE, 16));
            }
        ...
        case RUINS_TEST_SAMUS_REFLECTION_END_POSE_FULLSUIT:
            ...
            {
                gCurrentSprite.status &= ~SPRITE_STATUS_NOT_DRAWN;
                DMA_SET(3, sRuinsTestPal_SamusReflectionFullSuit, (gPalramBuffer + 0x3E0), C_32_2_16(DMA_ENABLE, 16));
            ...
            else if (gCurrentSprite.timer == 0x1E)
            {
                ...
                gCurrentSprite.status |= SPRITE_STATUS_NOT_DRAWN;
                DMA_SET(3, sRuinsTestGfx_SamusReflectionFullSuitTop, (gVramBuffer + 0x14280), C_32_2_16(DMA_ENABLE, 192));
                DMA_SET(3, sRuinsTestGfx_SamusReflectionFullSuitBottom, (gVramBuffer + 0x14680), C_32_2_16(DMA_ENABLE, 128));
            }
            break;
        ...
        case RUINS_TEST_SAMUS_REFLECTION_END_POSE_UPDATE_PALETTE:
            ...
            if (gCurrentSprite.workVariable == 0)
            {
                ...
                offset = gCurrentSprite.timer++;
                DMA_SET(3, &sRuinsTestPal_SamusReflectionFullSuit[offset * 16], (gPalramBuffer + 0x3E0), C_32_2_16(DMA_ENABLE, 16));
                if (offset > 8)
                {
