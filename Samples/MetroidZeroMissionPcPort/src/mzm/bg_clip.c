...
struct ItemInfo gItemsCollected[MAX_AMOUNT_OF_AREAS][MAX_AMOUNT_OF_ITEMS_PER_AREA];
u8 gNeverReformBlocks[MAX_AMOUNT_OF_AREAS][512];
u8 gNumberOfNeverReformBlocks[MAX_AMOUNT_OF_AREAS];
u8 gNumberOfItemsCollected[MAX_AMOUNT_OF_AREAS];
struct LastTank gLastTankCollected;
struct BackgroundPointersAndDimensions gBgPointersAndDimensions;

struct BG2Movement gBg2Movement;
u16 gBg0XPosition;
u16 gBg0YPosition;
u16 gBg1XPosition;
u16 gBg1YPosition;
...
s8 gCollectingTank;
u8 gDisableDoorAndTanks;
u8 gDisableClipdataChangingTransparency;
...
void BgClipSetBgBlockValue(u8 bg, u16 value, u16 yPosition, u16 xPosition)
{
    ...
    // Update tilemap
    dst = (u16*)(gVramBuffer + bg * 0x1000);
    if (xPosition & 0x10)
        dst = (u16*)(gVramBuffer + 0x800 + bg * 0x1000);
...
void BgClipSetBg1BlockValue(u16 value, u16 yPosition, u16 xPosition)
{
    ...
    // Update tilemap
    dst = (u16*)(gVramBuffer + 0x1000);
    if (xPosition & 0x10)
        dst = (u16*)(gVramBuffer + 0x1800);
