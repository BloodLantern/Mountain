...
struct EscapeDigits gEscapeTimerDigits;
...
void EscapeCheckReloadGraphics(void)
{
    ...
    {
        DMA_SET(3, sEscapeTimerDigitsGfx, gVramBuffer + 0x17800, C_32_2_16(DMA_ENABLE, sizeof(sEscapeTimerDigitsGfx) / 2));
    }
}
...
{
    DMA_SET(3, sEscapeTimerDigitsGfx, gVramBuffer + 0x17800, C_32_2_16(DMA_ENABLE, 0xB0));
    DMA_SET(3, sEscapeTimerDigitsGfx + 1024, gVramBuffer + 0x17c00, C_32_2_16(DMA_ENABLE, 0xB0));
