...
u8 gUnk_03004fc9;
union NonGameplayRAM gNonGameplayRAM;

u16 gBg0HOFS_NonGameplay;
u16 gBg0VOFS_NonGameplay;
u16 gBg1HOFS_NonGameplay;
u16 gBg1VOFS_NonGameplay;
u16 gBg2HOFS_NonGameplay;
u16 gBg2VOFS_NonGameplay;
u16 gBg3HOFS_NonGameplay;
u16 gBg3VOFS_NonGameplay;

u16 gCurrentOamRotation;
u16 gCurrentOamScaling;

ClipFunc_T gClipdataCodePointer;
u8 gCurrentClipdataAffectingAction;
struct CurrentAffectingClip gCurrentAffectingClipdata;
struct TilemapAndClipPointers gTilemapAndClipPointers;

u16 gEffectYPosition;
s16 gEffectYPositionOffset;
