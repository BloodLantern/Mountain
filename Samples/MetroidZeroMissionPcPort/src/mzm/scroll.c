...
u8 gSkipDoorTransition;
struct Scroll gCurrentScrolls[2];
struct Camera gCamera;
struct LockScreen gLockScreen;
s8 gScreenYOffset;
s16 gScreenXOffset;

u8 gFreeMovementLockCamera;
struct CameraScrollVelocityCaps gScrollingVelocityCaps;
const u8* gCurrentRoomScrollDataPointer;
