...
struct Haze gHazeInfo;
struct HazeLoop gHazeLoops[3];
...
HazeFunc_T gHazeProcessCodePointer;

u8 gCurrentHazeValue;

u16 gHazeValues[1280];
u16 gPreviousHazeValues[1280];
...
void HazeSetupCode(u8 hazeValue)
{
    ...
    switch (gCurrentHazeValue)
    {
        case HAZE_VALUE_GRADIENT:
            ...
            gHazeInfo.pAffected = gPalramBuffer;
            break;
    ...
    switch (gCurrentHazeValue)
    {
        ...
        case HAZE_VALUE_POWER_BOMB_EXPANDING:
            ...
            if (gHazeProcessCodePointer())
            {
                ...
                {
                    DMA_SET(3, gEwramBuffer + 0x9000, gEwramBuffer + 0x35000, C_32_2_16(DMA_ENABLE, PALRAM_SIZE / 4));
                }
                else
                {
                    DMA_SET(3, gEwramBuffer + 0x9000, gEwramBuffer + 0x35000, C_32_2_16(DMA_ENABLE, PALRAM_SIZE / 4 - 16));
                }
...
u32 Haze_PowerBombExpanding(void)
{
    ...
    dst = (u16*)(gEwramBuffer + 0x26d00) + i;
