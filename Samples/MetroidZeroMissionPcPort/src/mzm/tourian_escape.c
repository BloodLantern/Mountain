...
{
    DMA_SET(3, gOamData, gOamBuffer, (DMA_ENABLE | DMA_32BIT) << 16 | OAM_SIZE / sizeof(u32));
...
void unk_81ad8(void)
{
    ...
    DMA_SET(3, pal, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]) + 0xA0, DMA_ENABLE << 16 | 16);
...
void TourianEscapeInit(void)
{
    ...
    LZ77UncompVRAM(sTourianEscapeDebrisGfx, gVramBuffer + 0x13000);

    DMA_SET(3, sMotherShipBlowingUpExplosionsPal, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]), DMA_ENABLE << 16 | ARRAY_SIZE(sMotherShipBlowingUpExplosionsPal));
...
u8 TourianEscapeZebesExploding(void)
{
    ...
    switch (TOURIAN_ESCAPE_DATA.timer++)
    {
        ...
        case 246:
            ...
            LZ77UncompVRAM(sTourianEscapeZebesGfx, gVramBuffer);
            break;
        ...
        case 248:
            LZ77UncompVRAM(sTourianEscapeZebesTileTable, gVramBuffer + 0xF000);

            DMA_SET(3, sTourianEscapeExplodingPal, gPalramBuffer, DMA_ENABLE << 16 | ARRAY_SIZE(sTourianEscapeExplodingPal));
            DMA_SET(3, sTourianEscapeExplodingPal, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]), DMA_ENABLE << 16 | ARRAY_SIZE(sTourianEscapeExplodingPal));
...
u8 TourianEscapeSamusInHerShip(void)
{
    ...
    {
        case 0:
            LZ77UncompVRAM(sTourianEscapeSamusInHerShipSuitGfx, gVramBuffer);
            break;

        case 1:
            LZ77UncompVRAM(sMotherShipExplodingFlashGfx, gVramBuffer + 0x8000);
            break;

        case 2:
            LZ77UncompVRAM(sTourianEscapeSamusInHerShipSuitTileTable, gVramBuffer + 0x7000);
            LZ77UncompVRAM(sMotherShipExplodingFlashTileTable, gVramBuffer + 0xF000);

            if (gEquipment.suitMiscActivation & SMF_VARIA_SUIT)
            {
                DMA_SET(3, sTourianEscapeSamusInHerShipVariaSuitPal, gPalramBuffer,
                    DMA_ENABLE << 16 | ARRAY_SIZE(sTourianEscapeSamusInHerShipVariaSuitPal));
            }
            else
            {
                DMA_SET(3, sTourianEscapeSamusInHerShipPowerSuitPal, gPalramBuffer,
        ...
        case 160:
            LZ77UncompVRAM(sTourianEscapeSamusInHerShipSuitlessGfx, gVramBuffer);
            break;

        case 161:
            LZ77UncompVRAM(sTourianEscapeSamusInHerShipSuitlessTileTable, gVramBuffer + 0x7000);
            LZ77UncompVRAM(sTourianEscapeSamusInHerShipSuitlessEyesOpenedTileTable, gVramBuffer + 0x7800);

            DMA_SET(3, sTourianEscapeSamusInHerShipSuitlessPal, gPalramBuffer,
...
u8 TourianEscapeSamusLookingAround(void)
{
    ...
    {
        case 0:
            LZ77UncompVRAM(sTourianEscapeSamusSamusInHerShipLookingGfx, gVramBuffer);
            break;
        ...
        case 2:
            LZ77UncompVRAM(sTourianEscapeSamusSamusInHerShipLookingLeftTileTable, gVramBuffer + 0x8000);
            LZ77UncompVRAM(sTourianEscapeSamusSamusInHerShipLookingRightTileTable, gVramBuffer + 0x8800);

            DMA_SET(3, sTourianEscapeSamusLookingAroundPal, gPalramBuffer,
                DMA_ENABLE << 16 | ARRAY_SIZE(sTourianEscapeSamusLookingAroundPal));

            DMA_SET(3, sTourianEscapeSamusLookingAroundPal, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]),
                DMA_ENABLE << 16 | ARRAY_SIZE(sTourianEscapeSamusLookingAroundPal));
            break;
...
u8 TourianEscapeSamusSurrounded(void)
{
    ...
    {
        case 0:
            LZ77UncompVRAM(sTourianEscapeSamusSurroundedBackgroundGfx, gVramBuffer);
            break;

        case 1:
            LZ77UncompVRAM(sTourianEscape_49cb90, gVramBuffer + 0x8000);
            break;

        case 2:
            LZ77UncompVRAM(sTourianEscapeSamusSurroundedBackgroundTileTable, gVramBuffer + 0x7000);
            LZ77UncompVRAM(sTourianEscape_49fb70, gVramBuffer + 0x7800);

            DMA_SET(3, sTourianEscapeSamusSurroundedPal, gPalramBuffer, DMA_ENABLE << 16 | ARRAY_SIZE(sTourianEscapeSamusSurroundedPal));
...
u8 TourianEscapeSamusFlyingIn(void)
{
    ...
    switch (TOURIAN_ESCAPE_DATA.timer++)
    {
        ...
        case 1:
            LZ77UncompVRAM(sIntroSpaceBackgroundGfx, gVramBuffer);
            break;

        case 2:
            LZ77UncompVRAM(sIntroSpaceBackgroundTileTable, gVramBuffer + 0xF000);

            DMA_SET(3, sIntroTextAndShipPAL, gPalramBuffer, DMA_ENABLE << 16 | sizeof(sIntroTextAndShipPAL) / 2 + 16);
            DMA_SET(3, sIntroTextAndShipPAL, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]), DMA_ENABLE << 16 | sizeof(sIntroTextAndShipPAL) / 2 + 16);
...
u8 TourianEscapeSamusChasedByPirates(void)
{
    ...
    {
        case 0:
            LZ77UncompVRAM(sTourianEscapeSamusChasedBackgroundGfx, gVramBuffer);
            break;
        ...
        case 2:
            LZ77UncompVRAM(sTourianEscapeSamusChasedBackgroundTileTable, gVramBuffer + 0xE000);

            DMA_SET(3, sTourianEscapeSamusChasedBackgroundPal, gPalramBuffer,
                DMA_ENABLE << 16 | ARRAY_SIZE(sTourianEscapeSamusChasedBackgroundPal));
            DMA_SET(3, sTourianEscapeSamusChasedShipsPal, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]),
...
u8 TourianEscapeSamusChasedByPiratesFiring(void)
{
    ...
    switch (TOURIAN_ESCAPE_DATA.timer++)
    {
        ...
        case 1:
            DMA_SET(3, sTourianEscapeSamusChasedByPiratesFiringPal, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]),
...
u8 TourianEscapeSamusGettingShot(void)
{
    ...
    {
        case 0:
            LZ77UncompVRAM(sTourianEscapeSamusGettingShotGfx, gVramBuffer + 0x8000);
            break;
        ...
        case 2:
            LZ77UncompVRAM(sTourianEscapeSamusGettingShotTileTable, gVramBuffer + 0xF000);
            DMA_SET(3, sTourianEscapeSamusGettingShotPal, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]), DMA_ENABLE << 16 | ARRAY_SIZE(sTourianEscapeSamusGettingShotPal));
        ...
        case 336:
            DMA_SET(3, sTourianEscapeSamusGettingShotPal, gPalramBuffer, DMA_ENABLE << 16 | ARRAY_SIZE(sTourianEscapeSamusGettingShotPal));
...
u8 TourianEscapeSamusGoingToCrash(void)
{
    ...
    switch (TOURIAN_ESCAPE_DATA.timer++)
    {
        ...
        case 2:
            ...
            DMA_SET(3, sTourianEscapeExplodingPal, gPalramBuffer, DMA_ENABLE << 16 | ARRAY_SIZE(sTourianEscapeExplodingPal));
            DMA_SET(3, sTourianEscapeSamusGoingToCrashPal, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]),
...
u8 TourianEscapeSamusCrashing(void)
{
    ...
    {
        case 0:
            LZ77UncompVRAM(sTourianEscapeShipCrashingForegroundGfx, gVramBuffer);
            break;

        case 1:
            LZ77UncompVRAM(sTourianEscapeShipCrashingExplosionGfx, gVramBuffer + 0x8000);
            break;
        ...
        case 3:
            LZ77UncompVRAM(sTourianEscapeShipCrashingForegroundTileTable, gVramBuffer + 0x7000);
            LZ77UncompVRAM(sTourianEscapeShipCrashingExplosionTileTable, gVramBuffer + 0xF000);

            DMA_SET(3, sTourianEscapeSamusCrashingForegroundPal, gPalramBuffer,
                DMA_ENABLE << 16 | ARRAY_SIZE(sTourianEscapeSamusCrashingForegroundPal));
            break;

        case 4:
            DMA_SET(3, sTourianEscapeShipCrashingBackgroundAndShipPal, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]),
        ...
        case 104:
            DMA_SET(3, sTourianEscape_479f80, gPalramBuffer, DMA_ENABLE << 16 | ARRAY_SIZE(sTourianEscape_479f80));
            TOURIAN_ESCAPE_DATA.dispcnt = DCNT_BG0 | DCNT_BG1 | DCNT_OBJ;
...
u8 TourianEscapeSamusLookingAtSky(void)
{
    ...
    {
        case 0:
            LZ77UncompVRAM(sTourianEscapeSamusLookingAtSkyGfx, gVramBuffer);
            break;

        case 1:
            LZ77UncompVRAM(sTourianEscapeSamusLookingAtSkySkyBackgroundGfx, gVramBuffer + 0x8000);
            break;
        ...
        case 3:
            LZ77UncompVRAM(sTourianEscapeSamusLookingAtSkySkyBackgroundTileTable, gVramBuffer + 0xE000);
            LZ77UncompVRAM(sTourianEscapeSamusLookingAtSkyTopTileTable, gVramBuffer + 0xF000);
            LZ77UncompVRAM(sTourianEscapeSamusLookingAtSkyBottomTileTable, gVramBuffer + 0xF800);

            DMA_SET(3, sTourianEscapeSamusLookingAtSkyPal, gPalramBuffer, DMA_ENABLE << 16 | ARRAY_SIZE(sTourianEscapeSamusLookingAtSkyPal));
            DMA_SET(3, sTourianEscapeSamusLookingAtSkyPal, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]), DMA_ENABLE << 16 | ARRAY_SIZE(sTourianEscapeSamusLookingAtSkyPal));
...
u8 TourianEscapeSamusLookingAtMotherShip(void)
{
    ...
    {
        case 0:
            LZ77UncompVRAM(sTourianEscapeSamusLookingAtMotherShipGfx, gVramBuffer);
            break;

        case 1:
            LZ77UncompVRAM(sTourianEscapeSamusLookingAtMotherShipMotherShipGfx, gVramBuffer + 0x8000);
            break;

        case 2:
            LZ77UncompVRAM(sTourianEscapeSamusLookingAtMotherShipTileTable, gVramBuffer + 0x7000);
            LZ77UncompVRAM(sTourianEscapeSamusLookingAtMotherShipMotherShipTileTable, gVramBuffer + 0xF000);

            DMA_SET(3, sTourianEscapeSamusLookingAtMotherShipPal, gPalramBuffer,
        ...
        case 3:
            ...
            DMA_SET(3, sTourianEscapeRainPal, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]), DMA_ENABLE << 16 | ARRAY_SIZE(sTourianEscapeRainPal));
            DMA_SET(3, sStoryTextCutscenePAL, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]) + PALRAM_SIZE / 2 - 16 * 2, DMA_ENABLE << 16 | ARRAY_SIZE(sStoryTextCutscenePAL));
