...
void GalleryVBlank(void)
{
    ...
    {
        DMA_SET(3, ENDING_DATA.creditLineTilemap_1, gVramBuffer + ENDING_DATA.creditLineOffset_1,
            DMA_ENABLE << 16 | ARRAY_SIZE(ENDING_DATA.creditLineTilemap_1));
        DMA_SET(3, ENDING_DATA.creditLineTilemap_2, gVramBuffer + ENDING_DATA.creditLineOffset_2,
            DMA_ENABLE << 16 | ARRAY_SIZE(ENDING_DATA.creditLineTilemap_2));

        buffer = 0;
        DMA_SET(3, &buffer, gVramBuffer + 0x800 + ENDING_DATA.creditLineOffset_1,
            (DMA_ENABLE | DMA_32BIT | DMA_SRC_FIXED) << 16 | ARRAY_SIZE(ENDING_DATA.creditLineTilemap_1) / 2);
        buffer = 0;
        DMA_SET(3, &buffer, gVramBuffer + 0x800 + ENDING_DATA.creditLineOffset_2,
            (DMA_ENABLE | DMA_32BIT | DMA_SRC_FIXED) << 16 | ARRAY_SIZE(ENDING_DATA.creditLineTilemap_2) / 2);
    }
    else if (ENDING_DATA.unk_6 != 0)
    {
        DMA_SET(3, ENDING_DATA.creditLineTilemap_1, gVramBuffer + 0x800 + ENDING_DATA.creditLineOffset_1,
            DMA_ENABLE << 16 | ARRAY_SIZE(ENDING_DATA.creditLineTilemap_1));
        DMA_SET(3, ENDING_DATA.creditLineTilemap_2, gVramBuffer + 0x800 + ENDING_DATA.creditLineOffset_2,
            DMA_ENABLE << 16 | ARRAY_SIZE(ENDING_DATA.creditLineTilemap_2));

        buffer = 0;
        DMA_SET(3, &buffer, gVramBuffer + ENDING_DATA.creditLineOffset_1,
            (DMA_ENABLE | DMA_32BIT | DMA_SRC_FIXED) << 16 | ARRAY_SIZE(ENDING_DATA.creditLineTilemap_1) / 2);
        buffer = 0;
        DMA_SET(3, &buffer, gVramBuffer + ENDING_DATA.creditLineOffset_2,
            (DMA_ENABLE | DMA_32BIT | DMA_SRC_FIXED) << 16 | ARRAY_SIZE(ENDING_DATA.creditLineTilemap_2) / 2);
    }
...
void CreditsInit(void)
{
    ...
    LZ77UncompVRAM(sCreditsChozoWallBackgroundGfx, gVramBuffer);
    LZ77UncompVRAM(sCreditsChozoWallBackgroundTileTable, gVramBuffer + 0xE000);
    LZ77UncompVRAM(sCreditsChozoWallBottomTileTable, gVramBuffer + 0xD800);
    LZ77UncompVRAM(sCreditsCharactersGfx, gVramBuffer + 0x8000);

    DMA_SET(3, sCreditsChozoWallPAL, gPalramBuffer, DMA_ENABLE << 16 | sizeof(sCreditsChozoWallPAL) / 2);
    DMA_SET(3, sCreditsCharactersPAL, gPalramBuffer + 0x1A0, DMA_ENABLE << 16 | sizeof(sCreditsCharactersPAL) / 2);
...
u8 CreditsChozoWallMovement(void)
{
    ...
    switch (ENDING_DATA.timer++)
    {
        case 0:
            ...
            LZ77UncompVRAM(sCreditsChozoWallBottomGfx, gVramBuffer + 0x8000);
            break;
...
u8 CreditsChozoWallZoom(void)
{
    ...
    {
        case 0:
            LZ77UncompVRAM(sCreditsChozoWallBottomZoomedGfx, gVramBuffer);
            DMA_SET(3, sCreditsChozoWallPAL, gPalramBuffer, DMA_ENABLE << 16 | ARRAY_SIZE(sCreditsChozoWallPAL));
            gBg0YPosition = 0;
        ...
        case 1:
            LZ77UncompVRAM(sCreditsChozoWallBottomZoomedTileTable, gVramBuffer + 0xF000);
        ...
        case 193:
            LZ77UncompVRAM(sCreditsChozoDrawingGfx, gVramBuffer + 0x8000);
            break;

        case 194:
            LZ77UncompVRAM(sCreditsChozoDrawingTileTable, gVramBuffer + 0xF800);
...
void EndScreenInit(void)
{
    ...
    LZ77UncompVRAM(sEndingSamusPosingSpaceBackgroundGfx, gVramBuffer + 0x3000);
    LZ77UncompVRAM(sEndingLightGfx, gVramBuffer + 0xB000);
    LZ77UncompVRAM(sEndingSamusPosingGfx_1, gVramBuffer);
    LZ77UncompVRAM(sEndingSamusPosingGfx_2, gVramBuffer + 0x8000);

    LZ77UncompVRAM(sEndingSamusPosingSpaceBackgroundTileTable, gVramBuffer + 0xF800);
    LZ77UncompVRAM(sEndingLightTileTable, gVramBuffer + 0xF000);
    LZ77UncompVRAM(sEndingSamusPosingTileTable_1, gVramBuffer + 0xD000);
    LZ77UncompVRAM(sEndingSamusPosingTileTable_2, gVramBuffer + 0xE000);

    BitFill(3, 0, gVramBuffer + 0xD800, 0x800, 32);
    BitFill(3, 0, gVramBuffer + 0xE800, 0x800, 32);

    DMA_SET(3, sEndingPosingPAL, gPalramBuffer, DMA_ENABLE << 16 | ARRAY_SIZE(sEndingPosingPAL));
...
u8 EndScreenSamusPosing(void)
{
    ...
    switch (ENDING_DATA.oamTypes[0])
    {
        ...
        case 3:
            ...
            DMA_SET(3, sEndingWhitePalPointers[(u8)temp / 4],
                gPalramBuffer, DMA_ENABLE << 16 | ARRAY_SIZE(sEndingPosingPAL_White1));
            break;
    ...
    switch (ENDING_DATA.oamTypes[1])
    {
        case 1:
            ...
            LZ77UncompVRAM(sEndingSamusPosingGfx_3, gVramBuffer);
            LZ77UncompVRAM(sEndingSamusPosingTileTable_3, gVramBuffer + 0xD000);
        ...
        case 3:
            ...
            LZ77UncompVRAM(sEndingSamusPosingGfx_4, gVramBuffer + 0x8000);
            LZ77UncompVRAM(sEndingSamusPosingTileTable_4, gVramBuffer + 0xE000);
        ...
        case 5:
            ...
            LZ77UncompVRAM(sEndingSamusPosingGfx_5, gVramBuffer);
            LZ77UncompVRAM(sEndingSamusPosingTileTable_5, gVramBuffer + 0xD000);
        ...
        case 7:
            ...
            if (ENDING_DATA.endingNumber == 0)
            {
                LZ77UncompVRAM(sEndingSamusPosingFullSuitGfx, gVramBuffer + 0x8000);
                LZ77UncompVRAM(sEndingSamusPosingFullSuitTileTable, gVramBuffer + 0xE000);
            }
            else if (ENDING_DATA.endingNumber == 1)
            {
                LZ77UncompVRAM(sEndingSamusPosingHelmetOffGfx, gVramBuffer + 0x8000);
                LZ77UncompVRAM(sEndingSamusPosingHelmetOffTileTable, gVramBuffer + 0xE000);
            }
            else
            {
                LZ77UncompVRAM(sEndingSamusPosingSuitlessGfx, gVramBuffer + 0x8000);
                LZ77UncompVRAM(sEndingSamusPosingSuitlessTileTable, gVramBuffer + 0xE000);
            }
        ...
        case 19:
            DMA_SET(3, sEndingPosingPAL, gPalramBuffer, DMA_ENABLE << 16 | 0x50);
            ENDING_DATA.oamTypes[1]++;
            break;
...
void EndingImageInit(void)
{
    ...
    LZ77UncompVRAM(sEndingImagesTopGfxPointers[endingNumber], gVramBuffer);
    LZ77UncompVRAM(sEndingImagesBottomGfxPointers[endingNumber], gVramBuffer + 0x8000);
    LZ77UncompVRAM(sEndingImagesTopTileTablePointers[endingNumber], gVramBuffer + 0xE000);
    LZ77UncompVRAM(sEndingImagesHalfTileTablePointers[endingNumber], gVramBuffer + 0xF800);
    BitFill(3, 0x4FF04FF, gVramBuffer + 0xE800, 0x800, 0x20);
    DMA_SET(3, sEndingImagesPalPointers[endingNumber], gPalramBuffer, DMA_ENABLE << 16 | 0x100);
    ...
    if (ENDING_DATA.language == LANGUAGE_HIRAGANA)
        LZ77UncompVRAM(sEndingImageTextJapGfx, gVramBuffer + 0x11000);
    else
        LZ77UncompVRAM(sEndingImageTextGfx, gVramBuffer + 0x11000);

    DMA_SET(3, sEndingImageTextPAL, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]), DMA_ENABLE << 16 | sizeof(sEndingImageTextPAL) / 2);
...
void UnlockedOptionsInit(void)
{
    ...
    LZ77UncompVRAM(sUnlockedOptionsTileTable, gVramBuffer + 0x8000);
    BitFill(3, -1, gVramBuffer + 0x7FE0, 0x20, 32);
    BitFill(3, 0xF3FFF3FF, gVramBuffer + 0x8800, 0x800, 32);

    DMA_SET(3, sUnlockedOptionsPAL, gPalramBuffer + 0x1E0, DMA_ENABLE << 16 | ARRAY_SIZE(sUnlockedOptionsPAL));
...
u8 UnlockedOptionsPopUp(void)
{
    ...
    {
        case 0:
            BitFill(3, 0, gVramBuffer, 0x2000, 32);
...
void GalleryInit(void)
{
    ...
    LZ77UncompVRAM(sEndingImagesTopGfxPointers[endingNbr], gVramBuffer);
    LZ77UncompVRAM(sEndingImagesBottomGfxPointers[endingNbr], gVramBuffer + 0x8000);
    LZ77UncompVRAM(sEndingImagesTopTileTablePointers[endingNbr], gVramBuffer + 0xE000);
    LZ77UncompVRAM(sEndingImagesHalfTileTablePointers[endingNbr], gVramBuffer + 0xF800);

    BitFill(3, 0x4FF04FF, gVramBuffer + 0xE800, 0x800, 32);

    DMA_SET(3, sEndingImagesPalPointers[endingNbr], gPalramBuffer, DMA_ENABLE << 16 | PALRAM_SIZE / 4);
