...
void ChozodiaEscapeInit(void)
{
    ...
    LZ77UncompVRAM(sCutsceneZebesMotherShipBackgroundGfx, gVramBuffer);
    LZ77UncompVRAM(sCutsceneZebesGroundGfx, gVramBuffer + 0x8000);
    LZ77UncompVRAM(sCutsceneZebesRockyBackgroundGfx, gVramBuffer + 0xC800);
    LZ77UncompVRAM(sCutsceneZebesGroundTileTable, gVramBuffer + 0xA000);
    LZ77UncompVRAM(sCutscene_3b5168_TileTable, gVramBuffer + 0xA800);
    LZ77UncompVRAM(sCutsceneZebesMotherShipBackgroundTileTable, gVramBuffer + 0xB000);

    DMA_SET(3, sCutsceneZebesPAL, gPalramBuffer, DMA_ENABLE << 16 | ARRAY_SIZE(sCutsceneZebesPAL));
    DMA_SET(3, sCutsceneMotherShipPAL, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]), DMA_ENABLE << 16 | ARRAY_SIZE(sCutsceneMotherShipPAL));
...
u8 ChozodiaEscapeShipHeatingUp(void)
{
    ...
    if ((u16)timer < 127)
    {
        ...
        DMA_SET(3, src1, gPalramBuffer + 0x200, DMA_ENABLE << 16 | 16);
        DMA_SET(3, src2, gPalramBuffer + 0x280, DMA_ENABLE << 16 | 16);
    }
...
u8 ChozodiaEscapeShipBlowingUp(void)
{
    ...
    {
        case 0:
            LZ77UncompVRAM(sChozodiaEscapeCraterBackgroundGfx, gVramBuffer);
            break;
        ...
        case 3:
            LZ77UncompVRAM(sChozodiaEscapeCraterBackgroundTileTable, gVramBuffer + 0xE800);
            LZ77UncompVRAM(sMotherShipExplodingFlashTileTable, gVramBuffer + 0xF000);

            DMA_SET(3, sChozodiaEscapeShipExplodingPAL, gPalramBuffer, DMA_ENABLE << 16 | ARRAY_SIZE(sChozodiaEscapeShipExplodingPAL) - 16 * 2);
...
u8 ChozodiaEscapeShipLeavingPlanet(void)
{
    ...
    {
        case 0:
            LZ77UncompVRAM(sChozodiaEscapeZebesAndSkyGfx, gVramBuffer);
            PlayMusic(MUSIC_ESCAPE_SUCCESFUL, 0);
            break;

        case 1:
            LZ77UncompVRAM(sChozodiaEscapeSamusInBlueShipGfx, gVramBuffer + 0x8000);
            break;
        ...
        case 3:
            LZ77UncompVRAM(sChozodiaEscapeZebesBackgroundTileTable, gVramBuffer + 0xE800);
            LZ77UncompVRAM(sChozodiaEscapeZebesSkyTileTable, gVramBuffer + 0xF000);
            LZ77UncompVRAM(sChozodiaEscapeSamusInBlueShipTileTable, gVramBuffer + 0xF800);
            
            DMA_SET(3, sChozodiaEscapeMissionAccomplishedPAL, gPalramBuffer,
                DMA_ENABLE << 16 | ARRAY_SIZE(sChozodiaEscapeMissionAccomplishedPAL));
            DMA_SET(3, sChozodiaEscapeMissionAccomplishedPAL, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]),
                DMA_ENABLE << 16 | ARRAY_SIZE(sChozodiaEscapeMissionAccomplishedPAL));
...
u8 ChozodiaEscapeMissionAccomplished(void)
{
    ...
    switch (CHOZODIA_ESCAPE_DATA.timer++)
    {
        case 0:
            ...
            DMA_SET(3, sChozodiaEscapeSamusInBlueShipPAL, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]),
        ...
        case 48:
            ...
            DmaTransfer(3, CHOZODIA_ESCAPE_DATA.monochromePalette, gPalramBuffer, sizeof(CHOZODIA_ESCAPE_DATA.monochromePalette), 16);
