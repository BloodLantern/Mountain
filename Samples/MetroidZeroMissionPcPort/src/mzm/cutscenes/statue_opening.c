...
u8 StatueOpeningInit(void)
{
    ...
    unk_61f0c();
    DmaTransfer(3, sBossStatuesPAL, gPalramBuffer + 0x300, sizeof(sBossStatuesPAL), 16);
    DmaTransfer(3, sStatueOpeningPAL, gPalramBuffer, sizeof(sStatueOpeningPAL), 16);
    SET_BACKDROP_COLOR(COLOR_BLACK);

    CallLZ77UncompVram(sStatueOpeningRoomGfx, gVramBuffer + 0x1800 + sStatueOpeningPageData[0].graphicsPage * 0x4000);

    ptr = (const u8*)sTileset_65_Bg_Gfx;
    CallLZ77UncompVram(ptr, gVramBuffer + 0xFDE0 - C_16_2_8(ptr[2], ptr[1])); 
