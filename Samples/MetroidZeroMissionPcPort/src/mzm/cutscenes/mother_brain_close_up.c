...
u8 MotherBrainCloseUpLookingAtSamus(void)
{
    ...
    {
        case 0:
            DmaTransfer(3, sMotherBrainCloseUpBackgroundPal, gPalramBuffer, sizeof(sMotherBrainCloseUpBackgroundPal), 16);
            SET_BACKDROP_COLOR(COLOR_BLACK);

            // Load samus palette (varia or power suit)
            if (gEquipment.suitMiscActivation & SMF_VARIA_SUIT)
            {
                DmaTransfer(3, sMotherBrainCloseUpSamusVariaPal, gPalramBuffer + sizeof(sMotherBrainCloseUpBackgroundPal),
                    sizeof(sMotherBrainCloseUpSamusVariaPal), 16);
            }
            else
            {
                DmaTransfer(3, sMotherBrainCloseUpSamusPal, gPalramBuffer + sizeof(sMotherBrainCloseUpBackgroundPal),
            ...
            DmaTransfer(3, sMotherBrainCloseUpBigEyePal, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]), sizeof(sMotherBrainCloseUpBigEyePal), 16);
...
u8 MotherBrainCloseUpEyeOpening(void)
{
    ...
    {
        case 0:
            DmaTransfer(3, sMotherBrainCloseUpPal, gPalramBuffer, sizeof(sMotherBrainCloseUpPal), 16);
            SET_BACKDROP_COLOR(COLOR_BLACK);
            ...
            // Load eye graphics
            DmaTransfer(3, sMotherBrainCloseUpEyePal, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]), sizeof(sMotherBrainCloseUpEyePal), 16);
...
u8 MotherBrainCloseUpInit(void)
{
    ...
    DmaTransfer(3, sMotherBrainCloseUpTankViewPal, gPalramBuffer, sizeof(sMotherBrainCloseUpTankViewPal), 16);
    SET_BACKDROP_COLOR(COLOR_BLACK);
