...
u8 RidleyInSpaceShipLeaving(void)
{
    ...
    switch (CUTSCENE_DATA.timeInfo.subStage)
    {
        case 0:
            ...
            DmaTransfer(3, sRidleyInSpaceSpaceBackgroundPal, gPalramBuffer, sizeof(sRidleyInSpaceSpaceBackgroundPal), 16);
            ...
            DmaTransfer(3, sRidleyInSpace_39dc70_Pal, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]), sizeof(sRidleyInSpace_39dc70_Pal), 16);
...
u8 RidleyInSpaceRidleySuspicious(void)
{
    switch (CUTSCENE_DATA.timeInfo.subStage)
    {
        case 0:
            ...
            DmaTransfer(3, sRidleyInSpaceShipInteriorPal, gPalramBuffer, sizeof(sRidleyInSpaceShipInteriorPal), 16);
            SET_BACKDROP_COLOR(COLOR_BLACK);
...
u8 RidleyInSpaceRedAlert(void)
{
    switch (CUTSCENE_DATA.timeInfo.subStage)
    {
        case 0:
            // Load palette
            DmaTransfer(3, sRidleyInSpace_39d910_Pal, gPalramBuffer, sizeof(sRidleyInSpace_39d910_Pal), 16);
            SET_BACKDROP_COLOR(COLOR_BLACK);
...
u8 RidleyInSpaceInit(void)
{
    ...
    DmaTransfer(3, sRidleyInSpaceShipsPal, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]), sizeof(sRidleyInSpaceShipsPal), 16);
