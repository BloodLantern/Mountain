...
u8 StoryTextCutsceneInit(void)
{
    ...
    // Load palette
    DmaTransfer(3, sStoryTextCutscenePAL, gPalramBuffer + 0x1E0, sizeof(sStoryTextCutscenePAL), 16);
    SET_BACKDROP_COLOR(COLOR_BLACK);

    // Load tiletable and clear graphics
    CallLZ77UncompVram(sStoryTextCutsceneTileTable, gVramBuffer + sStoryTextCutscenePagesData[0].tiletablePage * 0x800);
    BitFill(3, 0, gVramBuffer + 0x3000 + sStoryTextCutscenePagesData[0].graphicsPage * 0x4000, 0x5000, 0x20);
