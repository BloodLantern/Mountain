...
void EnterTourianSwitchMetroidPalette(struct CutscenePaletteData* pPalette, u8 grabbedPal)
{
    if (grabbedPal == TRUE)
    {
        ...
        DmaTransfer(3, &sMetroidPAL_SamusGrabbed[pPalette->paletteRow * 16], gPalramBuffer + 0x380, 32, 0x10);
        return;
    }
    ...
    if (pPalette->active)
    {
        ...
        DmaTransfer(3, &sMetroidOAM_Moving_Frame10[8], gPalramBuffer + 0x380, 32, 0x10);
    }
}
...
u8 EnterTourianInit(void)
{
    ...
    unk_61f0c();
    DmaTransfer(3, sEnterTourianBackgroundPAL, gPalramBuffer, sizeof(sEnterTourianBackgroundPAL), 0x10);
    SET_BACKDROP_COLOR(COLOR_BLACK);

    DmaTransfer(3, sEnterTourianMetroidPAL, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]), sizeof(sEnterTourianMetroidPAL), 0x10);
    DmaTransfer(3, sMetroidPAL, gPalramBuffer + 0x300, sizeof(sMetroidPAL), 0x10);

    CallLZ77UncompVram(sEnterTourianDeadSpacePirateGfx_1, VRAM_OBJ);
    CallLZ77UncompVram(sEnterTourianDeadSpacePirateGfx_2, gVramBuffer + 0x10400);
    CallLZ77UncompVram(sEnterTourianDeadSpacePirateGfx_3, gVramBuffer + 0x10800);
    CallLZ77UncompVram(sMetroidGfx, gVramBuffer + 0x14000);
    
    CallLZ77UncompVram(sEnterTourianBackgroundGfx, gVramBuffer + sEnterTourianPageData[0].graphicsPage * 0x4000);
    CallLZ77UncompVram(sEnterTourianForegroundGfx, gVramBuffer + sEnterTourianPageData[1].graphicsPage * 0x4000);

    CallLZ77UncompVram(sEnterTourianBackgroundTileTable, gVramBuffer + sEnterTourianPageData[0].tiletablePage * 0x800);
    CallLZ77UncompVram(sEnterTourianForegroundTileTable, gVramBuffer + sEnterTourianPageData[1].tiletablePage * 0x800);
