...
u8 RidleyLandingRidleyFlying(void)
{
    ...
    {
        case 0:
            DmaTransfer(3, sRidleyLandingSkyBackgroundPAL, gPalramBuffer, 0xA0, 0x10);
			DmaTransfer(3, sRidleyLandingRidleyAndRocksPAL, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]), 0x40, 0x10);
			
            SET_BACKDROP_COLOR(COLOR_BLACK);
			
            CallLZ77UncompVram(sRidleyLandingRidleyFlyingBackgroundGfx, gVramBuffer + sRidleyLandingPageData[4].graphicsPage * 0x4000);
			CallLZ77UncompVram(sRidleyLandingRidleyAndRockShadowGfx, gVramBuffer + 4 * 0x4000);
			CallLZ77UncompVram(sRidleyLandingRidleyFlyingBackgroundTileTable, gVramBuffer + sRidleyLandingPageData[4].tiletablePage * 0x800);
...
u8 RidleyLandingShipLanding(void)
{
    ...
    {
        case 0:
            DmaTransfer(3, sCutsceneZebesPAL, gPalramBuffer, sizeof(sCutsceneZebesPAL), 0x10);
            DmaTransfer(3, sCutsceneMotherShipPAL, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]), sizeof(sCutsceneMotherShipPAL), 0x10);

            SET_BACKDROP_COLOR(COLOR_BLACK);

            CallLZ77UncompVram(sCutsceneZebesMotherShipBackgroundGfx, gVramBuffer + sRidleyLandingPageData[1].graphicsPage * 0x4000);
            CallLZ77UncompVram(sCutsceneZebesGroundGfx, gVramBuffer + sRidleyLandingPageData[3].graphicsPage * 0x4000);
            CallLZ77UncompVram(sCutsceneZebesRockyBackgroundGfx, gVramBuffer + 0x4C00 + sRidleyLandingPageData[2].graphicsPage * 0x4000);

            BitFill(3, 0, VRAM_OBJ, 0x800, 0x20);
            CallLZ77UncompVram(sCutsceneMotherShipEscapeShipParticlesGfx, VRAM_OBJ);

            CallLZ77UncompVram(sCutsceneZebesMotherShipBackgroundTileTable, gVramBuffer + sRidleyLandingPageData[1].tiletablePage * 0x800);
            CallLZ77UncompVram(sCutscene_3b5168_TileTable, gVramBuffer + sRidleyLandingPageData[2].tiletablePage * 0x800);
            CallLZ77UncompVram(sCutsceneZebesGroundTileTable, gVramBuffer + sRidleyLandingPageData[3].tiletablePage * 0x800);
...
u8 RidleyLandingInit(void)
{
    ...
    DmaTransfer(3, sCutscene_3a09d4_PAL, gPalramBuffer, sizeof(sCutscene_3a09d4_PAL), 0x10);
    DmaTransfer(3, gPalramBuffer, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]), 0x200, 0x20);
    SET_BACKDROP_COLOR(COLOR_BLACK);

    CallLZ77UncompVram(sRidleyLandingZebesBackgroundGfx, gVramBuffer + sRidleyLandingPageData[0].graphicsPage * 0x4000);
    CallLZ77UncompVram(sRidleyLandingZebesBackgroundTileTable, gVramBuffer + sRidleyLandingPageData[0].tiletablePage * 0x800);

    CallLZ77UncompVram(sRidleyLandingMotherShipGfx_1, VRAM_OBJ);
    CallLZ77UncompVram(sRidleyLandingMotherShipGfx_2, gVramBuffer + 0x10400);
    CallLZ77UncompVram(sRidleyLandingMotherShipGfx_3, gVramBuffer + 0x10800);
    CallLZ77UncompVram(sRidleyLandingMotherShipGfx_4, gVramBuffer + 0x10C00);
    CallLZ77UncompVram(sRidleyLandingMotherShipGfx_5, gVramBuffer + 0x11000);
    CallLZ77UncompVram(sRidleyLandingMotherShipGfx_6, gVramBuffer + 0x11400);
    CallLZ77UncompVram(sRidleyLandingMotherShipGfx_7, gVramBuffer + 0x11800);
    CallLZ77UncompVram(sRidleyLandingMotherShipGfx_8, gVramBuffer + 0x11C00);
    CallLZ77UncompVram(sRidleyLandingMotherShipGfx_9, gVramBuffer + 0x12000);
