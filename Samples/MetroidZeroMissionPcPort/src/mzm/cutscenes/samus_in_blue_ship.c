...
u8 SamusInBlueShipInit(void)
{
    ...
    DmaTransfer(3, sSamusInBlueShipPAL, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]), sizeof(sSamusInBlueShipPAL), 16);
    DmaTransfer(3, sSamusInBlueShipPAL, gPalramBuffer, sizeof(sSamusInBlueShipPAL), 16);
