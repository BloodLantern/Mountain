...
u8 RidleySpawnRidleyFlyingIn(void)
{
    ...
    {
        case 0:
            DmaTransfer(3, sRidleySpawnRidleyScreamingPAL, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]), sizeof(sRidleySpawnRidleyScreamingPAL), 0x10);
            CallLZ77UncompVram(sRidleySpawnScreamingGfx, VRAM_OBJ);
            
            CallLZ77UncompVram(sRidleySpawnBackgroundGfx, gVramBuffer + sRidleySpawnPageData[3].graphicsPage * 0x4000);
            CallLZ77UncompVram(sRidleySpawnBackgroundTileTable, gVramBuffer + sRidleySpawnPageData[3].tiletablePage * 0x800);
            DmaTransfer(3, sRidleySpawnBackgroundPAL, gPalramBuffer, sizeof(sRidleySpawnBackgroundPAL), 0x10);
...
u8 RidleySpawnInit(void)
{
    ...
    if (gEquipment.suitMiscActivation & SMF_VARIA_SUIT)
        DmaTransfer(3, sRidleySpawnSamusVariaPAL, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]), sizeof(sRidleySpawnSamusVariaPAL), 0x10);
    else
        DmaTransfer(3, sRidleySpawnSamusPAL, (&gPalramBuffer[sizeof(gPalramBuffer) / 2]), sizeof(sRidleySpawnSamusPAL), 0x10);
    ...
    CallLZ77UncompVram(sRidleySpawnBackgroundGfx, gVramBuffer + sRidleySpawnPageData[0].graphicsPage * 0x4000);
    CallLZ77UncompVram(sRidleySpawnBackgroundTileTable, gVramBuffer + sRidleySpawnPageData[0].tiletablePage * 0x800);

    CallLZ77UncompVram(sRidleySpawnSamusHelmetFaceGfx, gVramBuffer + sRidleySpawnPageData[1].graphicsPage * 0x4000);
    CallLZ77UncompVram(sRidleySpawnSamusHelmetTileTable, gVramBuffer + sRidleySpawnPageData[1].tiletablePage * 0x800);
    CallLZ77UncompVram(sRidleySpawnSamusFaceTileTable, gVramBuffer + sRidleySpawnPageData[2].tiletablePage * 0x800);
