...
struct InGameCutscene gInGameCutscene;
struct SuitFlashEffect gSuitFlashEffect;

u32 gInGameCutscenesTriggered[1];
...
u32 InGameCutsceneSamusCloseUp(u8 cutsceneNumber, u8 cutsceneNumberNoFlag)
{
    ...
    switch (gInGameCutscene.stage)
    {
        ...
        case 4:
            DmaTransfer(3, &sSamusCloseUpEyesGfx_1[0], gVramBuffer + 0xB940, 0x140, 16);
            DmaTransfer(3, gEwramBuffer + 0x2B000, gVramBuffer + 0x294, 0x14, 16);

            DmaTransfer(3, &sSamusCloseUpEyesGfx_1[256], gVramBuffer + 0xBD40, 0x140, 16);
            DmaTransfer(3, gEwramBuffer + 0x2B040, gVramBuffer + 0x2D4, 0x14, 16);

            DmaTransfer(3, &sSamusCloseUpEyesGfx_1[512], gVramBuffer + 0xC140, 0x140, 16);
            DmaTransfer(3, gEwramBuffer + 0x2B080, gVramBuffer + 0x314, 0x14, 16);

            DmaTransfer(3, &sSamusCloseUpEyesGfx_1[768], gVramBuffer + 0xC540, 0x140, 16);
            DmaTransfer(3, gEwramBuffer + 0x2B0C0, gVramBuffer + 0x354, 0x14, 16);

            DmaTransfer(3, &sSamusCloseUpEyesGfx_1[1024], gVramBuffer + 0xC940, 0x140, 16);
            DmaTransfer(3, gEwramBuffer + 0x2B100, gVramBuffer + 0x394, 0x14, 16);

          
            DmaTransfer(3, &sSamusCloseUpEyesGfx_1[1280], gVramBuffer + 0xCD40, 0x140, 16);
            DmaTransfer(3, gEwramBuffer + 0x2B140, gVramBuffer + 0x3D4, 0x14, 16);
            result = 1;
            break;

        case 6:
            DmaTransfer(3, &sSamusCloseUpEyesGfx_2[0], gVramBuffer + 0xB940, 0x140, 16);
            DmaTransfer(3, gEwramBuffer + 0x2B014, gVramBuffer + 0x294, 0x14, 16);

            DmaTransfer(3, &sSamusCloseUpEyesGfx_2[256], gVramBuffer + 0xBD40, 0x140, 16);
            DmaTransfer(3, gEwramBuffer + 0x2B014, gVramBuffer + 0x294, 0x14, 16);

            DmaTransfer(3, &sSamusCloseUpEyesGfx_2[512], gVramBuffer + 0xC140, 0x140, 16);
            DmaTransfer(3, gEwramBuffer + 0x2B094, gVramBuffer + 0x314, 0x14, 16);

            DmaTransfer(3, &sSamusCloseUpEyesGfx_2[768], gVramBuffer + 0xC540, 0x140, 16);
            DmaTransfer(3, gEwramBuffer + 0x2B0D4, gVramBuffer + 0x354, 0x14, 16);

            DmaTransfer(3, &sSamusCloseUpEyesGfx_2[1024], gVramBuffer + 0xC940, 0x140, 16);
            DmaTransfer(3, gEwramBuffer + 0x2B114, gVramBuffer + 0x394, 0x14, 16);


            DmaTransfer(3, &sSamusCloseUpEyesGfx_2[1280], gVramBuffer + 0xCD40, 0x140, 16);
            DmaTransfer(3, gEwramBuffer + 0x2B154, gVramBuffer + 0x3D4, 0x14, 16);
            result = 1;
            break;

        case 8:
            DmaTransfer(3, &sSamusCloseUpEyesGfx_3[0], gVramBuffer + 0xB940, 0x140, 16);
            DmaTransfer(3, gEwramBuffer + 0x2B028, gVramBuffer + 0x294, 0x14, 16);

            DmaTransfer(3, &sSamusCloseUpEyesGfx_3[256], gVramBuffer + 0xBD40, 0x140, 16);
            DmaTransfer(3, gEwramBuffer + 0x2B068, gVramBuffer + 0x2D4, 0x14, 16);

            DmaTransfer(3, &sSamusCloseUpEyesGfx_3[512], gVramBuffer + 0xC140, 0x140, 16);
            DmaTransfer(3, gEwramBuffer + 0x2B0A8, gVramBuffer + 0x314, 0x14, 16);

            DmaTransfer(3, &sSamusCloseUpEyesGfx_3[768], gVramBuffer + 0xC540, 0x140, 16);
            DmaTransfer(3, gEwramBuffer + 0x2B0E8, gVramBuffer + 0x354, 0x14, 16);

            DmaTransfer(3, &sSamusCloseUpEyesGfx_3[1024], gVramBuffer + 0xC940, 0x140, 16);
            DmaTransfer(3, gEwramBuffer + 0x2B128, gVramBuffer + 0x394, 0x14, 16);
            
            DmaTransfer(3, &sSamusCloseUpEyesGfx_3[1280], gVramBuffer + 0xCD40, 0x140, 16);
            DmaTransfer(3, gEwramBuffer + 0x2B168, gVramBuffer + 0x3D4, 0x14, 16);
            result = 1;
            break;
        ...
        case 12:
            DmaTransfer(3, gEwramBuffer + 0x1E000, gVramBuffer + 0x9000, 0x2000, 16);
...
void unk_5fd58(void)
{
    ...
    src = gEwramBuffer + 0x2AA94;
    dst = gEwramBuffer + 0x2B000;
...
u32 InGameCutsceneUpgradingSuit(u8 cutsceneNumber, u8 cutsceneNumberNoFlag)
{
    ...
    switch (gInGameCutscene.stage)
    {
        ...
        case 3:
            ...
            DMA_SET(3, gVramBuffer + (1 * BGCNT_VRAM_TILE_SIZE), gEwramBuffer + 0x1E000, C_32_2_16(DMA_ENABLE, BGCNT_VRAM_TILE_SIZE / 2));
        ...
        case 4:
            ...
            BitFill(3, (9 << 12) | 0xC0, gVramBuffer + (1 * BGCNT_VRAM_TILE_SIZE), 0x800, 16);
        ...
        case 16:
            ...
            DMA_SET(3, gEwramBuffer + 0x1E000, gVramBuffer + (1 * BGCNT_VRAM_TILE_SIZE), C_32_2_16(DMA_ENABLE, BGCNT_VRAM_TILE_SIZE / 2));
...
void InGameCutsceneCheckPlayOnTransition(void)
{
    ...
    switch (gInGameCutscene.queriedCutscene)
    {
        case IGC_CLOSE_UP:
            ...
            // Backup BG0 map
            DmaTransfer(3, gVramBuffer + 0x9000, gEwramBuffer + 0x1E000, 0x2000, 16);
            
            // Load graphics, tile table and palette
            CallLZ77UncompVram(sSamusCloseUpGfx, gVramBuffer + 0x9000);
            CallLZ77UncompWram(sSamusCloseUpBackgroundMap, gDecompBg0Map);
            CallLZ77UncompWram(sSamusCloseUpEyesTiletable, gEwramBuffer + 0x2B000);
            DMA_SET(3, sSamusCloseUpPal, gPalramBuffer + 0xE0, C_32_2_16(DMA_ENABLE, ARRAY_SIZE(sSamusCloseUpPal)));
