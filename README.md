...
In your project configuration, add the `Mountain/src` and `Mountain/externals/src` folders to your include path.
...
In the current state, you need the `Maths`, `ImGui` and `magic_enum` folders.
