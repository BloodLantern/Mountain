...
bool ImGui::DragVector2(const char* label, float v[2], float v_speed, float v_min, float v_max, const char* format, ImGuiSliderFlags flags)
{
...
bool ImGui::SliderVector2(const char* label, float v[2], float v_min, float v_max, const char* format, ImGuiSliderFlags flags)
{
...
bool ImGui::InputVector2(const char* label, float v[2], const char* format, ImGuiInputTextFlags flags)
{
